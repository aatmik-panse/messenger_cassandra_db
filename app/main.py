...
# Include routers - we don't need to override dependencies in the router objects
app.include_router(message_router)
app.include_router(conversation_router)

# Set dependency overrides on the app instance instead
...
async def startup_event():
    ...
    try:
        # First connect without specifying a keyspace
